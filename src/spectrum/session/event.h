...
typedef enum netchesszx_session_event {
    ...
    NETCHESSZX_SESSION_EVENT_MACH_ZX = 0x41,
...
#define NETCHESSZX_SESSION_EVENT_MACH_BASE 0x40u
#define NETCHESSZX_SESSION_EVENT_MACH_MASK 0xf8u
#define NETCHESSZX_SESSION_EVENT_IS_MACH(event) \
    ((uint8_t)(((uint8_t)(event) & NETCHESSZX_SESSION_EVENT_MACH_MASK) == \
               NETCHESSZX_SESSION_EVENT_MACH_BASE))
#define NETCHESSZX_SESSION_EVENT_MACH_PLATFORM(event) \
    ((uint8_t)(event) & 0x07u)
...
#define NETCHESSZX_SESSION_MQTT_HOST_NEW_LIVE_SESSION 0x20u
