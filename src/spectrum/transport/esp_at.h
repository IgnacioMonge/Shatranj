...
#define spectrum_esp_at_query_ip_with_retry spectrum_net_query_ip_with_retry
#define spectrum_esp_at_publish_ip_status spectrum_net_publish_ip_status
#define spectrum_esp_at_prepare_radio spectrum_net_prepare_radio
